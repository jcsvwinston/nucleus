...
- Generated at (UTC): 2026-06-09T21:13:35Z
- Branch: `main`
- Commit: `985495e`
...
| stable-api-http-data | success | 1s | `go test ./pkg/router ./pkg/model ./pkg/db -count=1` |
| stable-cli | success | 17s | `go test ./internal/cli -count=1` |
