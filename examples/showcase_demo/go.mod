...
require (
	github.com/jcsvwinston/nucleus v1.15.1
	github.com/jcsvwinston/orbit v1.8.3
	github.com/jcsvwinston/orbit/quarkbridge v0.4.2
	github.com/jcsvwinston/orbit/quarkdatasource v0.2.14
	github.com/jcsvwinston/quark v1.6.1
	modernc.org/sqlite v1.50.0
)

require github.com/jcsvwinston/orbit/agent v0.6.2
